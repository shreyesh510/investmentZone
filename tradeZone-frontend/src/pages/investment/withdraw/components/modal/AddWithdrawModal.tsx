...
interface AddWithdrawModalProps {
  ...
  isDarkMode: boolean;
  onClose: () => void;
  onSubmit: (data: { amount: number; platform: string; description: string; bankDetails: string }) => void;
  loading?: boolean;
  error?: string;
}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex gap-4 pt-2">
            <button
              ...
              className="flex-1 px-6 py-3 bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 disabled:from-gray-500 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-medium rounded-2xl transition-all duration-300 hover:scale-105"
            >
              {loading ? (
